...
CD1 = {"connection_type": "divergent", "mask": {"circular": {"radius": 0.25}},
       "kernel": {"uniform": {"min":0.6, "max":0.8}}, "weights":2.0,
       "delay": {"linear": {"c":2.0, "a":3/0.25}}}

# CD2 = {"connection_type": "divergent", "mask": {"circular": {"radius": 0.25}},
#        "kernel": {"uniform": {"min":0.6, "max":0.8}}, "weights":2.0,
#        "delay": {"linear": {"c":2.0, "a":3/0.25}}}

CD3 = {"connection_type": "divergent", "mask": {"doughnut": {"inner_radius":0.25, "outer_radius":0.6}},
       "kernel": {"p":0.5}, "weights":{"linear": {"c":1.0, "a":-1.0}}}
